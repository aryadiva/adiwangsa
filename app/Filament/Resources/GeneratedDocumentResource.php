...
class GeneratedDocumentResource extends Resource
{
    ...
    {
        return __('app.nav.generated_pdfs');
    }

    public static function getNavigationGroup(): string
    {
        return __('app.nav.group_documents');
    }

    public static function getModelLabel(): string
    {
        return __('app.nav.generated_document');
    }
        ...
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('document_type')
                    ->label(__('app.generated_document.document'))
                    ->badge()
                ...
                Tables\Columns\TextColumn::make('subject')
                    ->label(__('app.generated_document.subject'))
                ...
                Tables\Columns\TextColumn::make('created_at')
                    ->label(__('app.generated_document.generated_at'))
                    ->dateTime('Y-m-d H:i')
                    ->sortable(),
            ])
            ->actions([
                Tables\Actions\Action::make('download')
                    ->label(__('app.generated_document.download'))
                    ->icon('heroicon-o-arrow-down-tray')
                    ->url(fn (GeneratedDocument $record): string => route('generated-documents.download', $record))
                    ->openUrlInNewTab(),
                Tables\Actions\Action::make('delete')
                    ->label(__('app.generated_document.delete'))
                    ->icon('heroicon-o-trash')
                    ->color('danger')
                    ->requiresConfirmation()
                    ->modalHeading(__('app.generated_document.delete_heading'))
                    ->modalDescription(__('app.generated_document.delete_description'))
                    ->successNotificationTitle(__('app.generated_document.deleted'))
